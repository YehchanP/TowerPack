...
item replace entity @s hotbar.2 with splash_potion[potion_contents={potion:"minecraft:strong_strength"}] 1
item replace entity @s hotbar.3 with flint_and_steel[unbreakable={}] 1
item replace entity @s hotbar.4 with golden_apple 6
item replace entity @s hotbar.5 with spruce_planks 64
...
item replace entity @s inventory.23 with spruce_planks 64